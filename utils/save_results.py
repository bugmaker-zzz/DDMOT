...
def save_results(trackers, cfg, seq_name, frame, category, image, folder_identifier):
    save_path = os.path.join(cfg.save_path, cfg.spilt, folder_identifier, category, "data"); mkdir_if_inexistence(save_path)
