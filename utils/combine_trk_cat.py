...
def combine_category_result(cfg, folder_identifier):
    ...
    folder_identifier_list = folder_identifier.split(sep="_")
    tracking_name = folder_identifier_list[0] + '_' + folder_identifier_list[1]
    save_dir = os.path.join(root_dir, cfg.spilt, "tracker", "category_combined_data", tracking_name)
    ...
    for seq_tmp in seq_list:
        ...
        for cat_list in cat_lists:
            file_tmp = os.path.join(root_dir, cfg.spilt, folder_identifier, cat_list, "data", seq_tmp + '.txt')
